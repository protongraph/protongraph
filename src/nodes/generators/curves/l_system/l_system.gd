...
func _init() -> void:
	...
	set_input(0, "Axiom", ConceptGraphDataType.STRING, {"text": "F"})
	set_input(1, "Rules", ConceptGraphDataType.STRING, {"text": "F=F[+F][-F]"})
	set_input(2, "Generations", ConceptGraphDataType.SCALAR, 
		{"step": 1, "value": 2, "min": 1, "max": 6, "allow_greater": true, "allow_lesser": false})
	set_input(3, "Step Size", ConceptGraphDataType.SCALAR, {"value": 1.0})
	set_input(4, "Angle", ConceptGraphDataType.SCALAR, {"value": 45.0})
