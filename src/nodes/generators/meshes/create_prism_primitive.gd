...
func _init() -> void:
	...
	set_input(0, "Left to right", ConceptGraphDataType.SCALAR,
		{"value": 0.5, "min": 0, "max": 1.0, "allow_greater": false, "allow_lesser": false})

	set_input(1, "Size", ConceptGraphDataType.VECTOR3,
		{"value": 2, "min": 0, "allow_lesser": false})

	set_input(2, "Subdivision", ConceptGraphDataType.VECTOR3,
