...
func _init() -> void:
	...
	set_input(1, "Height", ConceptGraphDataType.SCALAR, {"value": 2})
	set_input(2, "Radial segments", ConceptGraphDataType.SCALAR,
		{"value": 64, "steps": 1, "min": 1, "allow_lesser": false})

	set_input(3, "Rings", ConceptGraphDataType.SCALAR,
