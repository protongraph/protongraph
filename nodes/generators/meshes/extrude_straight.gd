...
func _init() -> void:
	...
	set_input(0, "Polygon curve", DataType.VECTOR_CURVE_3D)
	set_input(1, "Depth", DataType.SCALAR)
	set_input(2, "Material", DataType.MATERIAL)
	set_input(3, "Use collision", DataType.BOOLEAN)
	set_input(4, "Smooth faces", DataType.BOOLEAN, {"value": true})
	set_input(5, "Axis", DataType.VECTOR3)
	set_input(6, "Local Space", DataType.BOOLEAN, {"value": false})
