...
func _init() -> void:
	...
	set_input(1, "Height", DataType.SCALAR)
	set_input(2, "Density x", DataType.SCALAR, {"step": 0.001})
	set_input(3, "Density y", DataType.SCALAR, {"step": 0.001})
	set_input(4, "Thickness", DataType.SCALAR)
